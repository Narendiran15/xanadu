...
(function($) {
    ...
    function build(element, opts) {
        ...
        awselect_html += '<div data-inactive-color="' + placeholder_active_color + '" style="color:' + placeholder_color + '" class = "content2">';
        if (selected !== false) {
    ...
    function switchPlaceholderColor(element) {
        var placeholder_inactive_color = element.find(".front_face .content2").attr("data-inactive-color");
        var placeholder_normal_color = element.find(".front_face .content2").css("color");
        element.find(".front_face .content2").attr("data-inactive-color", placeholder_normal_color);
        element.find(".front_face .content2").css("color", placeholder_inactive_color);
    ...
    function setValue(select) {
        ...
        $(awselect).find(".front_face .content2").prepend('<span class = "current_value">' + option_value.text() + "</span>");
